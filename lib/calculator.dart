...
class CalculatorPageState extends State<CalculatorPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("DL Calculator"), elevation: 0.0),
        body: Center(
            child: Container(
                child: Column(
          children: <Widget>[
            Container(
                ...
                child: TextField(
                  controller: _total1,
                  decoration: InputDecoration(labelText: "Enter Team 1 Runs"),
            ...
            Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(labelText: "Wickets Team 1"),
                  keyboardType: TextInputType.number,
                )),
            Container(
                padding: EdgeInsets.all(5.0),
                  ...
                  children: <Widget>[
                    Flexible(
                        ...
                        child: TextField(
                          controller: _overs1,
                          decoration:
                              InputDecoration(labelText: " Total overs Team 1"),
                          keyboardType: TextInputType.number,
                        )),
                  ],
                )),
                  ...
                  children: <Widget>[
                    Flexible(
                        ...
                        child: TextField(
                          controller: _overs2,
                          decoration:
                              InputDecoration(labelText: "Team 2 Left Overs"),
                          keyboardType: TextInputType.number,
                        )),
                  ],
                )),
